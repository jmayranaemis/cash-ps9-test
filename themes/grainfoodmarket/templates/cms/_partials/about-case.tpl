  ...
  <div class="cash-about__intro cash-about__section">
    <div class="cash-about__container cash-about__split">
      <div class="cash-about__copy">
        ...
        <h1>Grossiste alimentaire indépendant depuis 1984</h1>
        <p class="cash-about__lead">Depuis plus de 40 ans, Cash Alimentaire du Sud-Est accompagne les restaurateurs, hôteliers, pizzerias, snacks et métiers de bouche de la Côte d’Azur.</p>
    ...
    <div class="cash-about__container cash-about__facts" aria-label="Cash Alimentaire en bref">
      ...
      <div><strong>40+ ans</strong><span>D’expérience terrain</span></div>
  ...
  <div class="cash-about__section cash-about__section--ivory">
    <div class="cash-about__container cash-about__split cash-about__split--history">
      ...
      <div class="cash-about__copy">
        ...
        <ol class="cash-about__timeline">
          <li><strong>1984 — Les débuts à Nice</strong><span>Cash Alimentaire naît avec la volonté de servir au plus près les professionnels de la restauration et les métiers de bouche.</span></li>
          <li><strong>Une croissance régionale</strong><span>L’offre s’élargit, l’organisation logistique se structure à La Trinité et l’entreprise développe sa capacité de livraison sur la Côte d’Azur.</span></li>
          <li><strong>2024 — Elsi Food rejoint CASE</strong><span>Cette nouvelle étape renforce notre expertise des produits italiens premium&nbsp;: pâtes fraîches, fromages, charcuteries et spécialités sélectionnées.</span></li>
          <li><strong>Aujourd’hui</strong><span>Une équipe locale, plusieurs milliers de références et une même priorité&nbsp;: apporter des réponses concrètes aux professionnels.</span></li>
        </ol>
      </div>
    </div>
  </div>
  ...
  <div class="cash-about__section cash-about__values">
    <div class="cash-about__container">
      <div class="cash-about__heading">
        ...
        <h2>Des valeurs vécues au quotidien</h2>
  ...
  <div class="cash-about__section cash-about__section--green">
    <div class="cash-about__container cash-about__split">
      <div class="cash-about__copy">
        ...
        <a class="cash-about__button cash-about__button--light" href="{$urls.base_url}#familles-produits">Explorer les familles de produits</a>
      </div>
      <div class="cash-about__expertise-list">
        ...
        <div><strong>Un interlocuteur local</strong><span>Des conseils adaptés à votre établissement et à votre activité.</span></div>
  ...
  <div class="cash-about__section cash-about__section--ivory">
    <div class="cash-about__container cash-about__split cash-about__split--logistics">
      <div class="cash-about__copy">
        ...
        <h2>Une organisation conçue pour respecter vos produits</h2>
