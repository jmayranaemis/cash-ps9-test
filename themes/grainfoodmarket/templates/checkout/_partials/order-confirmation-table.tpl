    ...
    {block name='order_confirmation_table'}
            ...
            <span class="image">
              {if !empty($product.default_image)}
                <picture>
                  ...
                  <img src="{$product.default_image.bySize.cart_default.url}" loading="lazy" />
                </picture>
              {else}
                <picture>
                  ...
                  <img src="{$urls.no_picture_image.bySize.cart_default_default.url}" loading="lazy" />
                </picture>
              {/if}
            </span>
          </div>
      ...
      <table>
        {foreach $subtotals as $subtotal}
          {if isset($subtotal.type) && $subtotal.type !== 'tax'}
            <tr>
          ...
          {/if}
        {/foreach}
        {if isset($subtotal.tax.label) && $subtotals.tax.label !== null}
          <tr class="sub">
