...
*}
<div class="an_homeproducts-banner an_homeproducts-banner-default {if $banner.imgUrlFile != ''}an_homeproducts-banner-overlay{else}an_homeproducts-banner-noimg{/if} col-md-{$banner.col|intval}">
