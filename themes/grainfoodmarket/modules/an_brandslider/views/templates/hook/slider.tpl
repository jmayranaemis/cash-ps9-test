...
<div id="an_brandslider-block" class="clearfix col-lg-12">
	...
	<div class="owl-carousel an_brandslider-items">
		...
		<div class="an_brandslider-item" style="height: {$imgHeight|escape:'html':'UTF-8'}px;">
			<a href="{$manufacturer.link|escape:'html':'UTF-8'}" title="{l s='More about %s' sprintf=[$manufacturer.name] mod='an_brandslider'}">
				{if version_compare($smarty.const._PS_VERSION_, '1.7.0.0', '<>')}
					...
					<img src="{$manufacturer.image|escape:'html':'UTF-8' }" style="max-height: {$imgHeight|escape:'html':'UTF-8'}px;" width="{$imgWidth|escape:'html':'UTF-8'}" height="{$imgHeight|escape:'html':'UTF-8'}" alt="" />
					{/if}
				{else}
