...
$(function() {
	...
	$('.amegamenu_mobile-modal').click(function() {
		...
		modal.fadeOut(function () {
			...
			$('.menu-active').removeClass('menu-active').delay(300).queue(function(){
				$('.anmm-menu-item.mobile-open').removeClass('mobile-open').dequeue();;
	...
	$(document).on('click', '.anmm-list-mobile:not(.anmm-list-mobile-nolink) .anmm-link-arrow, .anmm-list-mobile-nolink .anmm-link', function() {
		if ($(this).parents('.anmm-menu-item').find('.anmm-dropdown').length) {
			$('#mobile_top_menu_wrapper').attr('data-level', +$('#mobile_top_menu_wrapper').attr('data-level') + 1);
			$('.amegamenu_mobile-modal').animate({scrollTop: 0},100);
			$(this).closest('.anmm-menu-item').addClass('mobile-open').delay(50).queue(function(){
				$(this).closest('.anmm-menu-item').find('.anmm-dropdown').addClass('menu-active').dequeue();
			});
		}
	});

	$(document).on('click', '.anmm-list-mobile .anmm-link .anmm-link-arrow', function(e) {
		e.preventDefault();
	});

	$(document).on('click', '.anmm-list-mobile-nolink .anmm-link', function(e) {
		e.preventDefault();
	});
	...
	$('.megamenu_mobile-btn-back').on('click', function() {
		$('.menu-active').removeClass('menu-active').delay(300).queue(function(){
			$(this).parents('.anmm-menu-item.mobile-open').removeClass('mobile-open').dequeue();;
...
$(document).ready(function () {
	...
	$('.fixed-menu-container .fixed-cart-products-count').html($("#_desktop_cart .cart-products-count").html());
	qtyButtons();
